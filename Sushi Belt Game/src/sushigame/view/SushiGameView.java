...
public class SushiGameView extends JPanel implements ActionListener, BeltObserver {
	...
	public SushiGameView(SushiGameModel game_model) {
		...
		JButton lowToHighButton = new JButton("Sort by Most Balance");
		lowToHighButton.setActionCommand("low");
		lowToHighButton.addActionListener(this);
		JButton spoiledButton = new JButton("Sort by Least Spoiled");
		spoiledButton.setActionCommand("spoiled");
		spoiledButton.addActionListener(this);
		JButton eatenButton = new JButton("Sort by Most Eaten");
		eatenButton.setActionCommand("eaten");
		eatenButton.addActionListener(this);
		...
		top_Panel.add(lowToHighButton);
		top_Panel.add(spoiledButton);
		top_Panel.add(eatenButton);
		...
		controller_messages = new JLabel(" Rotate the belt!");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("low")) {
			scoreboard.setLow(true);
			scoreboard.refresh();
		}
		if(e.getActionCommand().equals("spoiled")) {
			scoreboard.setSpoiled(true);
			scoreboard.refresh();
		}
		if(e.getActionCommand().equals("eaten")) {
			scoreboard.setEaten(true);
			scoreboard.refresh();
	...
	public void handleBeltEvent(BeltEvent e) {
		if (e.getType() == BeltEvent.EventType.ROTATE) {
			controller_messages.setText(" Rotate the belt!");
		}
	}
